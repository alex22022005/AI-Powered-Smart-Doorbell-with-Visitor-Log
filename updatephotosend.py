...
while True:
    ...
    if frame_count % frame_skip == 0:
        ...
        # Trigger doorbell if not already ringing and enough time has passed
        current_time = time.time()
        if (person_detected and not doorbell_active and 
    ...
    cv2.imshow("Smart Doorbell System - Person Detection", annotated_frame)
